...
export interface ApiBlogPostBlogPost extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Language learning blog article';
  ...
  attributes: {
    ...
    targetLanguage: Schema.Attribute.Enumeration<['pt', 'en', 'fr']> &
      Schema.Attribute.Required;
...
export interface ApiQuizAttemptQuizAttempt extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Student quiz completion history';
  ...
  attributes: {
    ...
    attemptKey: Schema.Attribute.String & Schema.Attribute.Unique;
    ...
    incorrectCount: Schema.Attribute.Integer &
      Schema.Attribute.Required &
      Schema.Attribute.SetMinMax<
        {
          min: 0;
...
export interface ApiQuizQuiz extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Language learning quiz';
    displayName: 'Quiz';
    pluralName: 'quizzes';
    singularName: 'quiz';
  };
